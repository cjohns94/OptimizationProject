...
%
% Notes::
% - 2/28/2020: This file is a modified version of fkine for use with my optimization project.
%   Instead of simply failing when the arm is unable to reach a given pose, it
%   returns an empty solution with the delta_error (e or enew). When it succeeds,
%   it returns both.
...
%NOTE 2/28/2020:
% This file has been modified in order to work with my optimization project.
% Instead of simply failing when the arm is unable to reach a given pose, it
% returns an empty solution with the pose error (e or enew). When it succeeds,
% it returns both. 

function [qt, pose_error] = ikine_modified(robot, tr, varargin)
